    ...
    <div id="admin-apartments-edit">
        ...
        <form action="{{ route('admin.apartments.update', $apartment) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $apartment->title) }}" placeholder="Titolo" minlength="5" maxlength="150">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="full_address" name="full_address" class="form-control @error('full_address') is-invalid @enderror" value="{{ old('full_address', $apartment->full_address) }}" placeholder="Indirizzo completo">
                @error('full_address')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="rooms_num" name="rooms_num" class="form-control @error('rooms_num') is-invalid @enderror" value="{{ old('rooms_num', $apartment->rooms_num) }}" placeholder="Numero di stanze" min="1" max="15">
                @error('rooms_num')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="beds_num" name="beds_num" class="form-control @error('beds_num') is-invalid @enderror" value="{{ old('beds_num', $apartment->beds_num) }}" placeholder="Numero di letti" min="1" max="15">
                @error('beds_num')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="baths_num" name="baths_num" class="form-control @error('baths_num') is-invalid @enderror" value="{{ old('baths_num', $apartment->baths_num) }}" placeholder="Numero di bagni" min="1" max="15">
                @error('baths_num')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="mq" name="mq" class="form-control @error('mq') is-invalid @enderror" value="{{ old('mq', $apartment->mq) }}" placeholder="Metri quadrati" min="1" max="15000">
                @error('mq')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $apartment->price) }}" placeholder="Prezzo" min="1" max="10000" step=".01">
                @error('price')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="description" cols="20" rows="3" class="form-control @error('description') is-invalid @enderror" placeholder="Breve descrizione dell'appartamento">{{ old('description', $apartment->description) }}</textarea>
                @error('description')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
