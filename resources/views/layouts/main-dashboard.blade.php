...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ Auth::user()->name ? route('admin.apartments.index') : 'false' }}">
                    ...
                    <ul class="navbar-nav ms-auto ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.sponsors.index') }}">{{__('Sponsorizza i tuoi appartamenti')}}</a>
