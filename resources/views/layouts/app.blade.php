...
<body>
    <div id="app">
        <header style="position: sticky; top:0; left:0; right:0; z-index: 20;">
                ...
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="{{ env("APP_FRONTEND") }}">
                        <div class="logo_boolbnb d-flex align-items-center">
                            ...
                            <h2 style="color:#ff5a5f; display:inline-block" class="mb-0 ps-1 m-text-cursive">BoolBnB</h2>
                        </div>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <!-- Left Side Of Navbar <ul class="navbar-nav me-auto"></ul> -->
                        ...
                        <ul class="navbar-nav ml-auto ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ env("APP_FRONTEND") }}">{{ __('Homepage') }}</a>
                            </li>
                            @endif
                            @else
